...
class Component:
    ...
    def set_charge(self, charge: int) -> Component: ...
    def set_type(self, type: ComponentType) -> Component: ...
    def set_molar_mass(self, molar_mass_kg_per_mol: float) -> Component: ...
    def set_truesdell_jones_parameters(
        self, alpha_meter: float = 0.0, beta_cubicmeter_per_mol: float = 0.0
    ) -> Component: ...
    def set_radius(self, radius_m: float) -> Component: ...
    def set_density(self, density_kg_per_m3: float) -> Component: ...
    def set_magnetic_saturation(
        self, magnetic_saturation_A_per_m: float
    ) -> Component: ...
