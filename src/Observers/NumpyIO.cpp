...
template<typename T>
void npy_save(const std::string& filename, const T* data, 
              const std::vector<size_t>& shape, const std::string& mode) {
    cnpy::npy_save(filename, data, shape, mode);
}

template<typename T>
void npz_save(const std::string& zipname, const std::string& varname,
...
template void npz_save<double>(const std::string&, const std::string&, const double*, const std::vector<size_t>&, const std::string&);
template void npz_save<float>(const std::string&, const std::string&, const float*, const std::vector<size_t>&, const std::string&);
...
template void npz_save<size_t>(const std::string&, const std::string&, const size_t*, const std::vector<size_t>&, const std::string&);
